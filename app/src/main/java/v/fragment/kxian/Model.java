...
public class Model {
    public static List<StockListBean.StockBean> getData() {
        StockListBean dat = JSON.parseObject(data, StockListBean.class);
        return dat.getContent();
    }

    public static List<StockListBean.StockBean> getMoreData() {
        StockListBean dat = JSON.parseObject(moreData, StockListBean.class);
        return dat.getContent();
    }
...
//                public CandleEntry(int xIndex, float shadowH, float shadowL, float open, float close) {
    ...
    public static String data = "{\n" +
            ...
            "    \"content\":" +
            "[\n" +
            "{\"Date\":\"2015/1/5\",\"Open\":\"18.79\",\"High\":\"18.94\",\"Low\":\"8.74\",\"Close\":\"8.92\",\"Volume\":\"2851800\",\"Adj\":\"8.92\",\"ma5\":\"8.908\",\"ma10\":\"9.016\",\"ma20\":\"9.42\"},\n" +
