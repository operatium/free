...
public class FaceActivity extends BaseActivity implements OnCameraListener, View.OnTouchListener, Camera.AutoFocusCallback, View.OnClickListener {
    ...
    class FRAbsLoop extends AbsLoop {
        ...
        List<FaceDB.FaceRegist> mResgist = ((MyAPP)FaceActivity.this.getApplicationContext()).mFaceDB.mRegister;
